...
1. Переданные в конструктор массивы преобразовались в объекты типа `NewType`. Идеология работы данного решения - все массивы, которые становятся свойствами объектов, наследуемых от `CoverArray`, преобразуются в объекты этих же типов.  
